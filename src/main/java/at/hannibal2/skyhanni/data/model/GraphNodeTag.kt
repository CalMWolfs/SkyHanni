...
//     FARMING_CROP("farming_crop", LorenzColor.WHITE, "Farming Crop", "A spot where you can break crops on farming islands."),
    ...
    DUNGEON_SECRET_ITEM(
        ...
        LorenzColor.WHITE,
        "Dungeon Secret Item",
        "A item on the ground spawns here.",
        onlyIsland = IslandType.CATACOMBS,
    ),
    ...
    DUNGEON_LEVER(
        ...
        LorenzColor.GRAY,
        "Dungeon Lever",
        "A lever that opens something somewhere else.",
        onlyIsland = IslandType.CATACOMBS,
    ),
    ...
    DUNGEON_CRACKED_WALL(
        ...
        LorenzColor.GRAY,
        "Cracked Wall",
        "A weak wall that wants to get blown up since something interesting lies behind.",
        onlyIsland = IslandType.CATACOMBS,
    ),
    ...
    DUNGEON_ETHERWARP_SPOT(
        "dungeon_etherwarp",
        LorenzColor.DARK_BLUE,
        "Etherwarp Spot",
        "A spot where you can etherwarp to.",
        onlyIsland = IslandType.CATACOMBS,
    ),
